...
;;- Chain 1
gp1 = define_global_params(PARAM_FILE)
gp1.alpha = a[0]
gp1.smin  = s[0]
gp1.smax  = sx[0]
gp1.norm  = c[0]
...
;;- Chain2
gp2 = define_global_params(PARAM_FILE)
gp2.alpha = a[1]
gp2.smin  = s[1]
gp2.smax  = sx[1]
gp2.norm  = c[1]
...
;;- Chain 3
gp3 = define_global_params(PARAM_FILE)
gp3.alpha = a[2]
gp3.smin  = s[2]
gp3.smax  = sx[2]
gp3.norm  = c[2]
...
;;- chain 4
gp4 = define_global_params(PARAM_FILE)
gp4.alpha = a[3]
gp4.smin  = s[3]
gp4.smax  = sx[3]
gp4.norm  = c[3]
...
;;- chain 5
gp5 = define_global_params(PARAM_FILE)
gp5.alpha = a[4]
gp5.smin  = s[4]
gp5.smax  = sx[4]
gp5.norm  = c[4]
...
;;- chain 6
gp6 = define_global_params(PARAM_FILE)
gp6.alpha = a[5]
gp6.smin  = s[5]
gp6.smax  = sx[5]
gp6.norm  = c[5]
